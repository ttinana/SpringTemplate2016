...
<html>
	<head>
		...
		<meta name="description" content="Astronomsko društvo Ruđer Bošković" />
		<meta name="keywords" content="adrb" />
	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header" class="skel-layers-fixed">
				...
				<nav id="nav">
					<ul>
						<li><a href="HelloPage.jsp">Home</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h2>This is Ion</h2>
					<p>Astronomsko društvo Ruđer Bošković<a href="http://templated.co">TEMPLATED</a></p>
					<ul class="actions">
