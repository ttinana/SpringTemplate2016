...
public class HelloController {
	...
	public void InitBinder(WebDataBinder binder) {
		// ovako nece preneti vrednost ovog parametra
		binder.setDisallowedFields(new String[] { "studentMobile" });

		// formating date in format yyyy***MM***dd
	...
	// http://localhost:8080/CRHoV2015/crhov/hi
	@RequestMapping("/hi")
	...
	// http://localhost:8080/CRHoV2015/crhov/org/hi/tijana
	...
	// http://localhost:8080/CRHoV2015/crhov/aha/zdravo/tijana/pavicic
	 ...
	 * 
	 */
	// http://localhost:8080/CRHoV2015/crhov/admissionForm
	...
	public void addingCommonObjects(Model model) {
		model.addAttribute("titleMsg",
				"12 cas addingCommonObjects on method level !");
